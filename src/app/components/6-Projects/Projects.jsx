...
export default function Projects() {
  ...
  const categories = [
    { name: "All", id: "All", icon: <FaCode /> },
    { name: "UX/UI", id: "ux-ui", icon: <FaPaintBrush /> },
    { name: "Mobile", id: "mobile-apps", icon: <FaMobileAlt /> },
    { name: "Web", id: "websites", icon: <FaGlobe /> },
  ];
    ...
    <section className="circular-projects-section" id="projects">
      <div className="container">
        ...
        <div className="carousel-progress-container">
          <div className="progress-label">Explore Projects</div>
